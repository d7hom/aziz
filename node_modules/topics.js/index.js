...
'صراحه | هل ترغب في إظهار حب ومرفق لشخص أو رؤية هذا الضعف؟',
...
"لو خيروك بين العيش في جزيرة بعيدة عن الأهل والأصدقاء على أن يكون لديك كافة وسائل الراحة و الرفاهية، أو أن تعيش في مكان قديم بدون وسائل الراحة ولكن مع الأهل والأصدقاء.",

"أو لو خيروك بين العيش بدون ذاكرة مع الأهل والأصدقاء أو أن تعيش بذاكرتك وحيدا وبعيدا عن كل ما تحب في الحياة.",
...
"لو خيروك بين الاعتذار عن ما صدر منك في حق شخص ما أو أن يقوم شخص ما بالإعتذار لك عن ما صدر منه في حقك.",

"لو خيروك بين الحقد على من يقوم بمضايقتك في الحياة وبين مسامحته.",

"لو خيروك بين إنقاذ النفس أو إنقاذ شخص عزيز عليك من التعرض إلى المتاعب في الحياة.",

"لو خيروك من العيش في عهد نبي من الأنبياء أو العيش في الوقت الحالي.",
...
"لو خيروك بين الحصول على مال كثير وبين أن تصبح أجمل رجل أو أمرأة في الكون.",

"لو خيروك بين المال وبين أن تصبح من أذكى أذكياء العالم.",

"لو خيروك بين الصحة وعدم وجود الأمراض وبين المال.",

"لو خيروك بين الذهاب إلى العمل ب ملابس البحر طوال النهار أو الذهاب إلى العمل طوال النهار بملابس جدك القديمة.",

"لو خيروك بين وضع كمية كبيرة من الملح على الطعام الخاص بصدقك أو تناول فطيرة من معجون الأسنان.",

"لو خيروك بين تناول نوع الشوكولاتة التي تفضلها ولكن مع الملح أو الليمون أو تناول ليمونة واحدة كبيرة الحجم مرة واحدة.",

"لو خيروك بالعيش مع صديق قام بالغدر بك أو مع عدوك في الحياة.لو خيروك بين قص الشعر قصير جدا أو بين صبغته باللون الأزرق الفاتح أو أي لون شاذ."
...
`بلديتنا عايز يعلم ابنه إنجليزي راح إبتدائي منفعش، راح ثانوي منفعش`،

راح الجامعة منفعش، قال لازم أوديه إنجلترا وأجوزه واحدة من هناك عشان

يعرف يتكلم إنجليزى، راح في الصباحية بيقولها “مستر هريدي موجود؟” قالتله

“نجولو مين؟”.`,

`واحدة ست راحت تقول لجوزها هو أنت ليه مش زي أستاذ سعيد جارنا

اللي فوق، ده كل يوم وهو نازل رايح الشغل بيبوس مراته، راح رد عليها

قالها أنا نفسي أعمل زيه بس هي هتوافق؟`,

`مسطول شاف هندية على جبينها نقطة حمرا قام قالها يا مدام يا مدام انتبهي

عم تسجلي فيديو.`,

`أم بخيلة قالت لابنها يا محمد روح اشتري ثلاثة رغيف واحد لي

وواحد لوالدك وواحد ليك وبعد ما راح الولد لشراء الرغيف طلعت

الأم من البلكونة وقالت: يا محمد رجع الرغيف الثالث أبوك مات.`,

`مرة رجل دق الباب على جدته، قالت له مين الطارق، قال لها حفيدك قالت له الجدة، كيف حتفيدني`,

`واحد بيتقدم لواحدة أبوها طلب منه مهر بـ 50 ألف جنيه، قالوا ليه يا عم الحاج هو أنت حسبت الكيلو بكام.`,

`واحد نام على السرير بالمقلوب، صحي الصبح لقي رجليه معمصة.`,

`الحمار في فرح أسد فقال له الأسد بس أنا معزمتش حمير أيه اللي جابك فرحى، قاله أنا كنت زيك أسد ولما أتجوزت بقيت حمار.`,

`مره نمر كان بيجري ورا عربية عشان يعاكس النمرة.`,

` كان فيه مرة سلحفاة دخلت مطعم وطلبت رز، قام الجرسون شلها رماها بره، رجعتله بعد شهر وقالته طب متزقش بس.`,

`واحد رخم نزل الشارع ملقاش حد يرخم عليه قام وقف قدام العمود وقاله عديني.`,

`مره واحد كان بيتفرج على مقطع ساخن أتلسع.`,

`عشر صعايدة كانوا بيحششوا البوليس كبس عليهم خمسة منهم اتمسكوا وخمسة استخبوا فى عربية البوكس.`,
...
`واحد ومراته متخانقين فبطلوا يكلموا بعض فكتب ورقة صحيني الساعة 6:30 علشان عندي شغل، وحط الورق على السرير ونام صحي الساعة 10:00 فلقى ورقة مكتوب عليها الساعة 6:30 يلا اصحى.`,
...
`مرة واحدة ست كل أما تقوم من النوم تلاقي وشها مبلول راحت للدكتور قالها أفضلي صاحية لحد أما تصحى و تشوفي وهى كانت نائمة شافت جوزها بيتفرج على التليفزيون ويقول هى دي الستات مش انتِ اتفوه.`,
...
`محشش اسمه سالم زعل من بيتهم وفكر يسافر و هو رايح المطار شاف لوحة مكتوب فيها “ارجع لنا سالم” رجع بيتهم يبكي قال طيب ليه زعلتوني`,

`مرة واحد اتصل بصاحبه فبيقول له انت نايم، رد عليه لا انا برد من الحلم.`,

`رة واحد بيقول لمراته عاوز أشوفك بدون مكياج، قالتله ليه بتلف وتدور قول على إنك عاوز تطلقني`,

`رة واحد خلف 7عيال سمى نفسه سفن اب`,

`مره مذيع طلع فاصل نزل مشحون`,
...
module.exports = {Tweets, Lo, Azkar, Sra7a, Jokes}
